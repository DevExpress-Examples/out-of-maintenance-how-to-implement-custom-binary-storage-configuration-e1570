...
<script runat="server">
	...
	Sub Application_Start(ByVal sender As Object, ByVal e As EventArgs)
		...
		DevExpress.Web.ASPxClasses.BinaryStorageConfigurator.RegisterStorageStrategy(New FileCacheStrategy(), AddressOf SupportsStrategy)
	End Sub
	Private Function SupportsStrategy(ByVal control As DevExpress.Web.ASPxClasses.ASPxWebControlBase) As Boolean
